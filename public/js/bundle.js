...
var showAlerts = function showAlerts(type, msg) {
  hideAlerts();
  var markup = "<div dir=\"rtl\" class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'با موفقیت وارد شدید');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', 'مشکلی در خروج اتفاق افتاده است.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (result.data.status === 'success') {
              if (type === 'password') {
                (0, _alerts.showAlerts)('success', ' رمز عبور به روز رسانی شد');
              } else {
                (0, _alerts.showAlerts)('success', 'حساب کاربری به روز رسانی شد');
              }
...
var updatePassword = document.querySelector('.form-user-password'); //DELEGATION
//updating user photo
//updating password
...
if (logInForm) {
  logInForm.addEventListener('submit', function (e) {
    e.preventDefault(); //DOM VALUES

    var form = new FormData(); // form.append('email', document.getElementById('email').value);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6942" + '/');
